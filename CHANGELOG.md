...
- Repository description now leads with the capability rather than "for SSR stacks", and GitHub topics added, so the module is discoverable on its own terms. No configuration change.
